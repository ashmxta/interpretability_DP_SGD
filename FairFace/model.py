...
'''
summary of changes:
- removed lenet architecture (not suitable for fairface dataset)
- removed resnet20 (too shallow), resnet110 / 1202 (overkill) for fairface
    - starting with resnet56
- todo: figure out optimal architecture for fairface if performing poorly here
- should be good yet to test
'''

def norm_layer(channels, norm_type='gn'):
    if norm_type == 'bn':
        return nn.BatchNorm2d(channels) # cnns
    elif norm_type == 'gn':
        ...
        return nn.InstanceNorm2d(channels) # style transfer / generative models
